  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
      ...
      <div className="flex md:hidden flex-col flex-1 overflow-hidden">
        ...
        <div className="sticky bottom-0 flex items-center justify-between px-4 py-2.5 pb-[calc(0.625rem+env(safe-area-inset-bottom,0px))] border-t border-border bg-background">
