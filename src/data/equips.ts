...
const RAW_EQUIPS: RawEquip[] = [
  ...
  { name: '生物辅助接驳器', set: '生物辅助', rarity: 5, type: '配件', sub1: '39+32', sub2: '42+21', special: 'AllDamageTakenScalar+17.14995857%', material: '息壤装备原件', voucher: '武陵调度券x8000', equipId: 'item_equip_t4_suit_heal01_edc_01', iconId: 'item_equip_t4_suit_heal01_edc_01' },
  ...
  { name: '纾难识别牌', set: '独立装备', rarity: 5, type: '配件', sub1: '39+43', sub2: '', special: 'AllDamageTakenScalar+17.76315789%', material: '息壤装备原件', voucher: '武陵调度券x8000', equipId: 'item_equip_t4_parts_wuling01_edc_01', iconId: 'item_equip_t4_parts_wuling01_edc_01' },
